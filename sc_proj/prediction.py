...
import warnings
import argparse
from run_pipeline import predict
...
def process_file(models, datasets, config_path, save_folder, setting = 'ood', pid_percentage = 0.2):
    ...
    # Run the pipeline    
    predict(models, datasets, model_config_path, data_config_path, save_folder, setting, pid_percentage)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--pid_percentage', type=float, required=False, help="The percentage of OOD cells in train data")
